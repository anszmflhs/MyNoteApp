...
class NoteAddUpdateActivity : AppCompatActivity() {
            ...
            when {
                ...
                description.isEmpty() -> {
                    ...
                    if (isEdit) {
                        ...
                        note.let { note -> note?.date = DateHelper.getCurrentDate() }
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        if (isEdit) {
            menuInflater.inflate(R.menu.item_note, menu)
        }
    ...
    private fun obtainViewModel(noteAddUpdateActivity: AppCompatActivity): NoteAddUpdateViewModel {
        val factory = ViewModelFactory.getInstance(noteAddUpdateActivity.application)
        return ViewModelProvider(
            noteAddUpdateActivity,
            factory
        ).get(NoteAddUpdateViewModel::class.java)
    }
}